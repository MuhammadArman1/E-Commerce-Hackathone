    ...
    <div className="p-8 font-sans">
      ...
      <div className="flex justify-center px-60 my-16 gap-32" id="ppageimg">
        ...
        <div className=" pl-8 w-[521px] ppw">
          ...
          <button className="px-7 py-3 bg-[#4EA0AE] text-white rounded-md hover:bg-teal-600 transition">
            <i className="bx bx-cart-alt bx-sm pr-3"></i>Add To Cart
          </button>
        </div>
      </div>
      ...
      <div className="w-[60vw] relative left-64 flex flex-col justify-center mb-10" id="ppagef">
        ...
        <div className="flex gap-5" id="ppimgmain">
          {/* Product Item 1 */}
          <div className="text-center ppimg">
            <Image
